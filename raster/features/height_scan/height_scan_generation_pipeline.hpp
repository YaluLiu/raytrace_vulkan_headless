...
public:
  ...
  bool ensureResources(const RasterTlasDescriptorInfo& tlasInfo, VkBuffer sensorBuffer,
...
private:
  ...
  void createPipeline();
  void updateDescriptorSet(const RasterTlasDescriptorInfo& tlasInfo, VkBuffer sensorBuffer,
                           VkBuffer sampleBuffer);
