...
void RasterSceneDescriptors::create(VkDevice device, uint32_t textureDescriptorCount, bool includeTileFrameUniformBinding)
{
  destroy();
...
void RasterSceneDescriptors::destroy()
{
...
void RasterSceneDescriptors::update(const VkDescriptorBufferInfo& frameUniforms,
...
void RasterSceneDescriptors::updateFrameUniform(const VkDescriptorBufferInfo& frameUniforms)
{
...
void RasterSceneDescriptors::updateTileFrameUniform(const VkDescriptorBufferInfo& tileFrameUniforms)
{
  if(m_device == VK_NULL_HANDLE || m_descSet == VK_NULL_HANDLE || m_descSetLayout == VK_NULL_HANDLE ||
